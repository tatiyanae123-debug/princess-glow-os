...
import { TodayVisualRepairV8 } from '@/components/today-reference-canvas-v8';
import { BecomingCabinetV1 } from '@/components/becoming-cabinet-v1';
...
export default function RootLayout({children}:{children:React.ReactNode}){
  return <html lang="en"><body><TodayViewportMode/><ShaktiProductLanguage/><TodayVisualRepairV8/>{children}<BecomingCabinetV1/><GlowNavigationNormalizer/><GlowWorldRuntime/></body></html>;
}
