...
export default async function FocusPage() {
  ...
  try {
    ...
    return <AppShell><div className="mx-auto max-w-3xl rounded-[22px] border border-amber-200 bg-amber-50 p-6"><p className="text-sm font-semibold">Focus Sessions need intelligence activation.</p><Link href="/settings/intelligence" className="mt-3 inline-block text-xs text-amber-900">Activate intelligence →</Link></div></AppShell>;
  }
