...
const rooms: Result[] = [
  ['dashboard','Dashboard','Personal command center','/dashboard'],['tasks','Tasks','Tactile execution planner','/tasks'],['calendar','Calendar','Editorial time wall','/calendar'],['planning','Planning','Life planning board','/planning'],['routines','Routines','Guided ritual journey','/routines'],['habits','Habits','Living habit garden','/habits'],['fitness','Fitness Studio','Training and recovery','/fitness'],['wellness','Wellness Sanctuary','Energy and care','/wellness'],['food','Food & Nutrition','Nourishment kitchen','/food'],['beauty','Beauty OS','Personal vanity','/beauty'],['beauty-lab','Beauty Lab','Product laboratory','/beauty/lab'],['hair','Hair','Salon and lifecycle','/hair'],['finance','Finance','Financial command center','/finance'],['financial-brain','Financial Brain','Forecasting and decisions','/finance/brain'],['goals','Goals','Future-life journey','/goals'],['projects','Projects','Project studio','/projects'],['brain','Glow Brain','AI concierge intelligence','/brain'],['concierge','Concierge','Approval service desk','/concierge'],['notes','Notes','Writing desk','/notes'],['settings','Settings','OS control center','/settings'],['world','Life World','Spatial digital home','/world'],['briefings','Morning & Night Briefs','Adaptive daily briefings','/briefings']
].map(([id,title,subtitle,href])=>({id,type:'Room',title,subtitle,href}));
...
export default async function SearchPage({searchParams}:{searchParams:Promise<{q?:string}>}){
  ...
  if(term){
    ...
    results=[
      ...rooms.filter(room=>`${room.title} ${room.subtitle}`.toLowerCase().includes(term.toLowerCase())),
