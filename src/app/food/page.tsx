...
import { FoodIntelligenceStudioFinal } from '@/components/food/food-intelligence-studio-final';
...
export default async function FoodPage(){
 ...
 return <AppShell><FoodIntelligenceStudioFinal initial={serialized} nextEvent={nextEvent?{id:nextEvent.id,title:nextEvent.title,startAt:nextEvent.startAt.toISOString()}:null} foodSpendCents={foodSpendCents} foodPurchaseCount={monthEntries.length}/></AppShell>
}
