...
import { FoodIntelligenceStudioV2 } from '@/components/food/food-intelligence-studio-v2';
...
export default async function FoodPage(){
 ...
 return <AppShell><FoodIntelligenceStudioV2 initial={serialized} nextEvent={nextEvent?{id:nextEvent.id,title:nextEvent.title,startAt:nextEvent.startAt.toISOString()}:null} foodSpendCents={foodSpendCents} foodPurchaseCount={monthEntries.length}/></AppShell>
}
