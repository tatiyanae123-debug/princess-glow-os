...
import { FoodIntelligenceStudio } from '@/components/food/food-intelligence-studio';
...
export default async function FoodPage(){
 ...
 return <AppShell><FoodIntelligenceStudio initial={serialized} nextEvent={nextEvent?{id:nextEvent.id,title:nextEvent.title,startAt:nextEvent.startAt.toISOString()}:null} foodSpendCents={foodSpendCents} foodPurchaseCount={monthEntries.length}/></AppShell>
}
