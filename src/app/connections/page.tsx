...
import { CalendarDays, Cloud, Link2, LockKeyhole, Mail, RefreshCw, ShieldCheck, Smartphone, Sparkles } from 'lucide-react';
  ...
  return <AppShell><SectionPage eyebrow="Connections" title="Connections" description="Nurture what matters. Keep the services that support your life close, private, and understandable.">
    <div className="space-y-4">
      <section className="grid gap-4 xl:grid-cols-3">
        <Card><div className="flex items-center justify-between"><div className="flex items-center gap-2"><Link2 size={15} className="text-[#C9727E]"/><h2 className="glow-display text-[18px]">Inner Circle</h2></div><Link href="#connection-details" className="text-[10px] text-[#C9727E]">View all</Link></div><div className="mt-5 flex gap-5"><div className="text-center"><span className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#FDF3F2] text-[#C9727E]"><Cloud size={18}/></span><p className="mt-2 text-[11px]">Google</p><p className="text-[9px] text-[#9A9088]">Calendar + Gmail</p></div><div className="text-center"><span className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#F1E8D9] text-[#9A7A3D]"><Smartphone size={18}/></span><p className="mt-2 text-[11px]">Apple</p><p className="text-[9px] text-[#9A9088]">Reminders bridge</p></div></div><div className="mt-5 rounded-[12px] bg-[#FFF8F5] p-4 text-center"><p className="glow-display text-[14px] italic text-[#5C4D47]">Your connected world should make life feel lighter, not louder.</p></div></Card>
      ...
      <section id="connection-details" className="grid scroll-mt-24 gap-4 lg:grid-cols-2"><GoogleConnectionCard overview={overview}/><AppleRemindersCard connection={appleConnection}/></section>
