...
const groups=[
 ...
 {title:'Life',items:[['Life Maintenance','/life/maintenance'],['Digital Life','/life/digital'],['Environment Intelligence','/home/environment'],['Style Intelligence','/closet/style']]},
 {title:'Beauty',items:[['Douyin Guided Look','/makeup/douyin'],['Facial Practice','/beauty/facial-practice'],['Makeup Studio','/makeup'],['Gua Sha','/beauty/gua-sha']]},
