...
import { GlowMatterField } from '@/components/glow-matter-field';
...
function roomFor(pathname: string) {
  ...
  if (pathname.startsWith('/brain') || pathname.startsWith('/graph') || pathname.startsWith('/inbox') || pathname.startsWith('/intake') || pathname.startsWith('/rules') || pathname.startsWith('/notices')) return 'brain';
