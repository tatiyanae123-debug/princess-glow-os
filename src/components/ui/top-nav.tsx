  ...
  return <>
    <header className="flex items-center justify-between gap-3 border-b border-[#e6d8cf] pb-2 text-[#65544e]">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <Link href="/notices" aria-label="Glow Notices" title="Glow Notices" className="rounded-full border border-[#dfd2c9] bg-white/35 p-2 text-[#7b6962]"><BellRing size={12}/></Link>
