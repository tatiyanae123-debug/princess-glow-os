...
const UTILITIES = [['Gmail','/gmail'],['Import','/import'],['Notices','/notices'],['Connections','/connections'],['Settings','/settings']] as const;
...
const REFERENCE_GROUPS: {label:string;items:{label:string;href:string;icon:LucideIcon}[]}[] = [
  {label:'TODAY',items:[{label:'Home',href:'/dashboard',icon:HomeIcon},{label:'Dashboard',href:'/today',icon:Grid2X2},{label:'Briefings',href:'/briefings',icon:NotebookTabs},{label:'Debriefs',href:'/briefings/evening',icon:CircleDollarSign}]},
  {label:'LIFE',items:[{label:'Calendar',href:'/calendar',icon:CalendarDays},{label:'Tasks',href:'/tasks',icon:CheckSquare2},{label:'Reminders',href:'/reminders',icon:Bell},{label:'Timeline',href:'/timeline',icon:CircleDot},{label:'Goals',href:'/goals',icon:Target}]},
  {label:'MIND',items:[{label:'Brain',href:'/brain',icon:BrainCircuit},{label:'Memory',href:'/memory',icon:NotebookTabs},{label:'Observations',href:'/observations',icon:NotebookTabs},{label:'Graph',href:'/graph',icon:Waves}]},
  {label:'WELLNESS',items:[{label:'Wellness',href:'/wellness',icon:Heart},{label:'Fitness',href:'/fitness',icon:Dumbbell},{label:'Food',href:'/food',icon:Utensils},{label:'Medications',href:'/maintenance',icon:Pill}]},
  {label:'BEAUTY',items:[{label:'Beauty',href:'/beauty',icon:WandSparkles},{label:'Beauty Lab',href:'/beauty/lab',icon:FlaskConical},{label:'Hair',href:'/hair',icon:Sparkles}]},
];
