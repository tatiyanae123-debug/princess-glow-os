...
export const navItems: NavItem[] = [
  ...
  { label: 'Fitness', href: '/fitness', icon: Dumbbell, description: 'Train with intention' },
  { label: 'Beauty', href: '/beauty', icon: Sparkles, description: 'Keep the routine refined' },
  { label: 'Beauty Lab', href: '/beauty-lab', icon: Sparkles, description: 'Understand products and formulas' },
  { label: 'Hair', href: '/hair', icon: Waves, description: 'Tend your crown and care cycle' },
