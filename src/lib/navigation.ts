...
export const navItems: NavItem[] = [
  ...
  { label:'Routines', href:'/routines', icon:Sparkles, description:'Run adaptive morning, night, reset and care rituals' },
  ...
  { label:'Food', href:'/food', icon:Utensils, description:'Plan meals, groceries, pantry and meal prep' },
