...
export const navItems: NavItem[] = [
  ...
  { label: 'Habits', href: '/habits', icon: Flame, description: 'Build steady rituals' },
  { label: 'Routines', href: '/routines', icon: RefreshCcw, description: 'Repeat what supports you' },
  ...
  { label: 'Work', href: '/work', icon: Briefcase, description: 'Maintain steady momentum' },
