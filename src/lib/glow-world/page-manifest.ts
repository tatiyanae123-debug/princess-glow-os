...
export const GLOW_PAGE_MANIFESTS: GlowPageManifest[] = [
  ...
  manifest('beauty.nails', '/beauty/nails', 'Nails', 'beauty', 'studio', '/beauty', 'nails', 'beauty-studio', 'open', ['product','routine']),
  manifest('beauty.brows', '/beauty/brows', 'Brows', 'beauty', 'studio', '/beauty', 'brows', 'beauty-studio', 'open', ['product','routine']),
  manifest('beauty.lashes', '/beauty/lashes', 'Lashes', 'beauty', 'studio', '/beauty', 'lashes', 'beauty-studio', 'open', ['product','routine']),
  manifest('beauty.oral', '/beauty/oral', 'Oral Care', 'beauty', 'studio', '/beauty', 'oral-care', 'beauty-studio', 'open', ['product','routine']),
