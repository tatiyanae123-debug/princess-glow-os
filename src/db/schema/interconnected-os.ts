...
export const universalIntakeArtifacts = pgTable('universal_intake_artifacts', {
  ...
  contentDataUrl: text('content_data_url'),
  detectedType: text('detected_type'),
  detectedTitle: text('detected_title'),
  extracted: jsonb('extracted').$type<Record<string, unknown>>().notNull().default({}),
  proposedDestinations: jsonb('proposed_destinations').$type<string[]>().notNull().default([]),
  analysisStatus: text('analysis_status').notNull().default('analyzed'),
