...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/medications', destination: '/wellness?view=medications', permanent: false },
      ...
      { source: '/spending', destination: '/finance?view=spending', permanent: false },
      { source: '/subscriptions', destination: '/finance?view=subscriptions', permanent: false },
      { source: '/forecast', destination: '/finance?view=forecast', permanent: false },
      { source: '/transactions', destination: '/finance?view=transactions', permanent: false },
